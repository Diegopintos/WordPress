	...
	class WPMovieLibrary_Details extends WPMOLY_Details_Module {
		...
		public function init() {
			...
			if ( ! wpmoly_details_audio_requirements_met() ) {
				add_action( 'init', 'wpmoly_details_audio_l10n' );
				add_action( 'admin_notices', 'wpmoly_details_audio_requirements_error' );
				return false;
			}
		...
		public function register_hook_callbacks() {
			...
			add_action( 'plugins_loaded', 'wpmoly_details_audio_l10n' );
		 ...
		 */
		private function wpmoly_details_audio_requirements_error() {
		...
		public static function require_wpmoly_first() {
			...
			$this_plugin      = basename( $this_plugin_path ) . '/wpmoly-details-audio.php';
